"""Pong physics engine for JEPA world model training.

Smooth linear ball dynamics with wall/paddle bounces.
Better for JEPA than pool (discontinuous collisions) because:
  - Ball trajectory between bounces is LINEAR
  - Only 10 state floats (vs pool's 28)
  - Paper-aligned: smooth dynamics like PushT/Reacher
...
if __name__ == "__main__":
    ...
    if args.preview:
        ...
        print(f"Generating {args.episodes} Pong episodes × {args.steps} steps "
              f"(frameskip=5)...")
